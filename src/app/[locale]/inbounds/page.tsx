...
import { ChevronDownIcon, ChevronRight, ChevronRightIcon, Loader2Icon, XIcon } from "lucide-react";
  ...
  const columns = useMemo(() => {
    return [
      ...
      },
      {
        ...
        cell: ({ row }) => <Badge className="uppercase">{row.getValue("status")}</Badge>,
        enableSorting: false,
        enableHiding: false
      },
      {
                  ...
                  >
                    ...
                    <AlertDialogContent>
                        ...
                        <AlertDialogFooter>
                          ...
                          <AlertDialogAction onClick={()=> { mutationConfirm.mutate([row.original]) }}>
            ...
            <AlertDialog>
                  ...
                  >
                    ...
                    <AlertDialogContent>
                        ...
                        <AlertDialogFooter>
                          <AlertDialogCancel>Cancel</AlertDialogCancel>
                          <AlertDialogAction onClick={()=> { mutationUpdateStatus.mutate(row.original.id) }}>
                            {mutationUpdateStatus.isPending &&  <Loader2Icon className="mr-2 h-4 w-4 animate-spin" /> }
                            Confirm
                          </AlertDialogAction>
                      </AlertDialogFooter> 
                    </AlertDialogContent>      
    ...
    <>
      <Tabs
        ...
        <CommonTable
            ...
            pageSize={pageSize}
            pageCount={Math.ceil(
              (inbounds?.meta?.pagination?.total || 0) / pageSize
            ) || 1}
